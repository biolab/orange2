...
##        self.setIcon(QPixmap("OrangeWidgetsIcon.gif"))
        ...
        owcalibButton=QPushButton("Calibration Plot",self)
        ...
        self.owcalib = OWCalibrationPlot()
        ...
        self.owcalib.link(self.owtl, "results")
        self.owcalib.link(self.owo, "target")
        ...
        self.connect(owcalibButton,SIGNAL("clicked()"),self.owcalib.show)
