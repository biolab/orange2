...
##        self.setIcon(QPixmap("OrangeWidgetsIcon.gif"))
        ...
        owliftButton=QPushButton("Lift Curve",self)
        ...
        self.owlift.link(self.owtl, "results")
        self.owlift.link(self.owo, "target")
        ...
        self.connect(owliftButton,SIGNAL("clicked()"),self.owlift.show)
