...
class OWDemo(QVBox):
    def __init__(self,parent=None):
        ...
        oweButton=QPushButton("Ensemble",self)
...
of how easy it is to use of Orange Widgets
        ...
        self.owe.link(self.owo, "cdata")
        self.owv.link(self.owe, "ctree")
        ...
        self.connect(oweButton,SIGNAL("clicked()"),self.owe.show)
