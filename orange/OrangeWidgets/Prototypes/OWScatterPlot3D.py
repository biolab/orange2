...
class OWScatterPlot3D(OWWidget):
    ...
    def __init__(self, parent=None, signalManager=None, name="Scatter Plot 3D"):
        ...
        OWGUI.hSlider(self.controlArea, self, "alphaValue", box="Transparency",
    ...
    def updateGraph(self):
      ...
      self.graph.setXaxisTitle(self.axisCandidateAttrs[self.xAttr].name)
      self.graph.setYaxisTitle(self.axisCandidateAttrs[self.yAttr].name)
      self.graph.setZaxisTitle(self.axisCandidateAttrs[self.zAttr].name)
