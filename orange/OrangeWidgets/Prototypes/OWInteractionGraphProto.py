...
class OWInteractionGraphProto(OWWidget):
    ...
    def __init__(self, parent=None, signalManager = None):
        OWWidget.__init__(self, parent, signalManager, "Interaction graph prototype")
        ...
        OWGUI.button(self.space, self, "Send interaction graph", callback=self.sendGraphClick)
