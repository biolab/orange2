...
l1=svm.SVMLearner()
l1.kernel_func=svm.kernels.RBFKernelWrapper(core.ExamplesDistanceConstructor_Euclidean(table), gamma=0.5)
...
l2=svm.SVMLearner()
l2.kernel_func=svm.kernels.RBFKernelWrapper(
...
l3=svm.SVMLearner()
l3.kernel_func = svm.kernels.CompositeKernelWrapper(
