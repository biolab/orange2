...
# Arguments: name, #iterations, runNo, isNewFile

t__name = t__sys.argv[1]
t__iterations = int(t__sys.argv[2])
t__runNo = int(t__sys.argv[3])

t__crashname, t__errorname, t__newname, t__changedname, t__random1name, t__random2name = ["outputs/%s.%s.%s.txt" % (t__name, t__string.zfill(t__runNo, 5), t) for t in ["crash", "error", "new", "changed", "random1", "random2"]]
t__officialname = "outputs/%s.txt" % t__name
