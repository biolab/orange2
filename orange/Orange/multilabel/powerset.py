""" 
.. index:: Powerset Learner
   
.. index:: 
   single: multilabel;  Powerset Learner
...
class PowersetLearner(_multibase.MultiLabelLearner):
    """
...
class PowersetClassifier(_multibase.MultiLabelClassifier):
