...
=================================
Orange Statistics for Predictions
=================================
...
:class:Orange.evaluation.testing.ExperimentResults as computed by functions from orngTest and which contains
predictions obtained through cross-validation, leave one-out, testing on
training data or test set examples.
"""
