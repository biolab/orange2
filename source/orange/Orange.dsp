...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../include" /I "ppp" /I "px" /I "$(PYTHON)\include" /I "$(GNUWIN32)\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ORANGE_EXPORTS" /D "LINK_C45" /Fr /FD /Zm700 /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "../include" /I "ppp" /I "px" /I "$(PYTHON)\include" /I "$(GNUWIN32)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ORANGE_EXPORTS" /Fr /FD /GZ /Zm700 /c
# SUBTRACT CPP /YX
...
# ADD LINK32 libgslcblas.a libgsl.a ole32.lib oleaut32.lib /nologo /dll /debug /machine:I386 /out:"d:\ai\orange\orange_d.pyd" /libpath:"$(PYTHON)/libs" /libpath:"$(GNUWIN32)/lib"
