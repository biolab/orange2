...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "include" /I "$(PYTHON)\include" /I "orange" /I "orange/px" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ORANGENE_EXPORTS" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GR /GX /ZI /Od /I "include" /I "$(PYTHON)\include" /I "orange" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ORANGENE_EXPORTS" /YX /FD /GZ /c
