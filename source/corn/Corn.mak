...
!IF "$(CFG)" != "Corn - Win32 Release" && "$(CFG)" != "Corn - Win32 Debug" && "$(CFG)" != "Corn - Win32 Python 24"
...
LINK32=link.exe
LINK32_FLAGS=orange.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\corn.pdb" /machine:I386 /out:"$(OUTDIR)\corn.pyd" /implib:"$(OUTDIR)\corn.lib" /libpath:"../../lib" /libpath:"$(PYTHON)\libs" 
LINK32_OBJS= \
	"$(INTDIR)\corn.obj" \
	"$(INTDIR)\numeric_interface.obj" \
...
ALL : "include - Win32 Python 24" "$(OUTDIR)\corn.pyd"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GR /GX /O2 /I "../include" /I "$(PYTHON24)\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CORN_EXPORTS" /Fp"$(INTDIR)\Corn.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=orange.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\corn.pdb" /machine:I386 /out:"$(OUTDIR)\corn.pyd" /implib:"$(OUTDIR)\corn.lib" /libpath:"../../lib" /libpath:"$(PYTHON24)\libs" 
LINK32_OBJS= \
	"$(INTDIR)\corn.obj" \
	"$(INTDIR)\numeric_interface.obj" \
...
$(DS_POSTBUILD_DEP) : "include - Win32 Python 24" "$(OUTDIR)\corn.pyd"
   del "..\..\24\corn.pyd*"
	"c:\program files\upx" "obj\Release24\corn.pyd" -o "..\..\24\corn.pyd"
	copy obj\Release24\corn.lib ..\..\24\lib\corn.lib
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
