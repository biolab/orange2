...
LINK32=link.exe
LINK32_FLAGS=orange.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:none /machine:I386 /out:"$(OUTDIR)\corn.pyd" /implib:"$(OUTDIR)\corn.lib" /libpath:"../../lib" /libpath:"$(PYTHON)\libs" 
LINK32_OBJS= \
	"$(INTDIR)\corn.obj" \
	"$(INTDIR)\numeric_interface.obj" \
