...
rem nmake /f  temp.mak CFG="Orange - Win32 Release"
del temp.mak
cd ..
...
rem nmake /f  temp.mak CFG="Corn - Win32 Release"
del temp.mak
cd ..
...
rem nmake /f  temp.mak CFG="orangeom - Win32 Release"
del temp.mak
cd ..
...
rem nmake /f  temp.mak CFG="orangene - Win32 Release"
del temp.mak
cd ..
