...
class OWKMeans(OWWidget):
    settingsList = ["K", "optimized", "optimizationFrom", "optimizationTo",
                    "scoring", "distanceMeasure", "classifySelected",
                    "addIdAs", "classifyName", "initializationType",
                    "restarts", "runAnyChange"]
    ...
    initializations = [
        ("Random",
         orngClustering.kmeans_init_random),
        ("Diversity",
    ...
    scoringMethods = [
        ("Silhouette (heuristic)",
         orngClustering.score_fastsilhouette),
        ("Silhouette",
         orngClustering.score_silhouette),
        ("Between cluster distance",
         orngClustering.score_betweenClusterDistance),
        ("Distance to centroids",
         orngClustering.score_distance_to_centroids)
        ]
