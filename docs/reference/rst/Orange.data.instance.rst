...
generated by function :obj:`Orange.data.variable.new_meta_id()`. Id's can
...
.. class:: Instance
    ...
    .. method:: get_metas([key_type])
        ...
        ``str`` or :obj:`Orange.data.variable.Variable` and
        determines whether
        ...
        :param key_type: the key type; either ``int``, ``str`` or :obj:`~Orange.data.variable.Variable`
        :type key_type: ``type``
