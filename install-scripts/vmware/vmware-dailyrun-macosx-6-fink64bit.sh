#!/bin/bash
#
# Should be run as: ./vmware-dailyrun-macosx-6-fink64bit.sh
#

VMRUN='/Library/Application Support/VMware Fusion/vmrun'
VMIMAGE='/Volumes/Data/vmware/Mac OS X Server 10.6 64-bit (64-bit Fink).vmwarevm/Mac OS X Server 10.6 64-bit.vmx'
WAIT_START_TIME=300
WAIT_STOP_TIME=600
WAIT_RESTART_TIME=120
RETRIES=5
IP_ADDRESS='172.16.213.104'
NAME='Mac OS X 10.6 (64-bit Fink)'
