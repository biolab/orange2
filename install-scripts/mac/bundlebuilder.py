...
class AppBuilder(BundleBuilder):
    ...
    # additional search paths relative to Resources
    additionalPaths = []
    ...
    def preProcess(self):
        ...
        if self.mainprogram is not None:
            origmainprogram = self.mainprogram
    ...
    def _getSiteCode(self):
        SITE_PYwithAdditionalPaths = SITE_PY
	for apath in self.additionalPaths:
            SITE_PYwithAdditionalPaths += "sys.path.append(sys.path[0] + '/%s')\n" % apath
	print SITE_PYwithAdditionalPaths
        return compile(SITE_PYwithAdditionalPaths % {"semi_standalone": self.semi_standalone},
