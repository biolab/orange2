...
t__crashname, t__errorname, t__newname, t__changedname, t__random1name, t__random2name = ["%s/%s.%s.txt" % (t__outputsdir, t__name, t) for t in ["crash", "error", "new", "changed", "random1", "random2"]]
