...
t__crashname, t__errorname, t__newname, t__changedname, t__random1name, t__random2name = ["%s/%s.%s.%s.txt" % (t__outputsdir, t__name, t, t__sys.version[:3]) for t in ["crash", "error", "new", "changed", "random1", "random2"]]
